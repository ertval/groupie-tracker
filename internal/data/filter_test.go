...
func TestStore_FilterArtists_CreationDate(t *testing.T) {
	tests := []struct {
		name      string
		fromYear  *int
		toYear    *int
...
func TestStore_FilterArtists_FirstAlbumYear(t *testing.T) {
	tests := []struct {
		name     string
		fromYear *int
		toYear   *int
...
func TestStore_FilterArtists_MemberCounts(t *testing.T) {
	tests := []struct {
		name         string
		memberCounts []int
		wantMin      int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			params := ArtistFilterParams{MemberCounts: tt.memberCounts}
...
func TestStore_FilterArtists_Countries(t *testing.T) {
	tests := []struct {
		name      string
		countries []string
		wantMin   int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			params := ArtistFilterParams{Countries: tt.countries}
...
func TestStore_FilterArtists_Combined(t *testing.T) {
	tests := []struct {
		name    string
		params  ArtistFilterParams
		wantMin int
...
func TestStore_GetArtistFilterOptions(t *testing.T) {
	store := createMockService(t)
...
func createMockService(t *testing.T) *Store {
	t.Helper()
